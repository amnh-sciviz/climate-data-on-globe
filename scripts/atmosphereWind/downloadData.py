...
parser.add_argument('-level', dest="LEVEL", type=float, default=25000.0, help="bar level")
parser.add_argument('-out', dest="OUTPUT_DIR", default="../../data/atmosphere_wind", help="Output dir")
